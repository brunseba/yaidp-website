      ...
      links: [
        ...
        },
        {
          ...
          items: [
            ...
            {
              label: 'GitHub',
              href: 'https://github.com/brunseba/yaidp-website.git',
            },
          ],
        },
      ],
      copyright: `Copyright © ${new Date().getFullYear()} The SparrowHawkOfHills, Inc. Built with Docusaurus.`,
    },
    prism: {
